...
% IJJ=J/2+1:Jref-J/2-1; misprint
IJJ=J/2+2:Jref-J/2; % correction 17-Jul 2026
% set linear operator
...
for n=1:N, % time loop
    ...
    % u=real(ifft(uh));    ut(1:Jref,n+1)=u;  misprint
    u=real(ifft(uh_new));    ut(1:Jref,n+1)=u; % correction 17-Jul 2026
    uh=uh_new; uh(IJJ)=0; 
end
